...
var CubeApp = React.createClass({
  ...
  getInitialState: function() {
    ...
    var width = this.props.initwidth - this.props.borderpx;
    var height = this.props.initheight - this.props.borderpx;
...
function interactiveexamplestart() {
  ...
  g_applicationstate = {borderpx:10, cubes:[], xsize:500, ysize:500, zsize:500, initwidth: startwidth, initheight:startheight };
